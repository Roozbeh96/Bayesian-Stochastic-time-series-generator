    ...
    methods
        ...
        function Increasing_Res_sto(Obj, factor)
            if Obj.type == "Exp"
                ...
                %                 if Obj.name == "GenWT7"
                std_uprime_shorttime = load('std_uprime_shorttime_GenWT7.mat').std_uprime_shorttime_GenWT7;
                std_wprime_shorttime = load('std_wprime_shorttime_GenWT7.mat').std_wprime_shorttime_GenWT7;
                %                     rho = -0.3;
