...
% loglog(X.wavenumb(logIndices,1)*X.eta_spec(1,ind_Gen_WT7_4),X.PowSpecDen_k(ind_Gen_WT7_4,logIndices)/...
...
% loglog(VF_GenWT7.wavenumb(logIndices,1)*VF_GenWT7.eta_spec(1,ind_Gen_WT7_4),VF_GenWT7.PowSpecDen_k(ind_Gen_WT7_4,logIndices)/...
...
% loglog(Y.wavenumb(logIndices,1)*Y.eta_spec(1,ind_Gen_WT10_21),Y.PowSpecDen_k(ind_Gen_WT10_21,logIndices)/...
...
% 
% loglog(VF_GenWT10.wavenumb(logIndices,1)*VF_GenWT10.eta_spec(1,ind_Gen_WT10_21),VF_GenWT10.PowSpecDen_k(ind_Gen_WT10_21,logIndices)/...
