function [data] = data_prep_mac()

fprintf('Reading data started...\n')
data = struct;
%<<<<Loading Generated modal velocity field>>>>

WT7VF = load(['/Users/roozbehehsani/Google Drive/My Drive/Research/DATABASE/' ...
    'Generated, ordered,spaced VF/VLFIELD(WindTunnel(m1)).mat']);
WT10VF = load(['/Users/roozbehehsani/Google Drive/My Drive/Research/DATABASE/' ...
    'Generated, ordered,spaced VF/VLFIELD(WindTunnel(m2)).mat']);
ASLVF = load(['/Users/roozbehehsani/Google Drive/My Drive/Research/DATABASE/' ...
    'Generated, ordered,spaced VF/VLFIELD(ASL).mat']);

WT7Prof = load(['/Users/roozbehehsani/Google Drive/My Drive/Research/DATABASE/' ...
    'Generated UMZ/UMZ(WindTunnel(m1)).mat']);
WT10Prof = load(['/Users/roozbehehsani/Google Drive/My Drive/Research/DATABASE/' ...
    'Generated UMZ/UMZ(WindTunnel(m2)).mat']);
ASLProf = load(['/Users/roozbehehsani/Google Drive/My Drive/Research/DATABASE/' ...
    'Generated UMZ/UMZ(ASL).mat']);

uGenWT7 = WT7VF.ufieldGenWT7;
uprimeGenWT7 = uGenWT7-mean(uGenWT7,2);%WT7VF.uprimefieldGenWT7;%
wGenWT7 = WT7VF.wfieldGenWT7;
zGenWT7 = WT7Prof.meanzWT7;

uGenWT10 = WT10VF.ufieldGenWT10;
uprimeGenWT10 = uGenWT10-mean(uGenWT10,2);%WT10VF.uprimefieldGenWT10;%
wGenWT10 = WT10VF.wfieldGenWT10;
zGenWT10 = WT10Prof.meanzWT10;


uGenASL = ASLVF.ufieldGenABL;
uprimeGenASL = uGenASL-mean(uGenASL,2);%ASLVF.uprimefieldGenABL;%
wGenASL = ASLVF.wfieldGenABL;
...
PIVWT7 = load(['/Users/roozbehehsani/Google Drive/My Drive/Research/DATABASE/' ...
    'Experimental/Wind Tunnel/PIV/Mesh/7[m:s]/mesh_07ms_a_velocity.mat']);
PIVWT10 = load(['/Users/roozbehehsani/Google Drive/My Drive/Research/DATABASE/' ...
    'Experimental/Wind Tunnel/PIV/Mesh/10[m:s]/mesh_10ms_a_velocity.mat']);
HotWireWT7 = load(['/Users/roozbehehsani/Google Drive/My Drive/Research/DATABASE/' ...
    'Experimental/Wind Tunnel/Hotwire/7[m:s]/mesh_07ms_a_Xwire']);
HotWireWT10 = load(['/Users/roozbehehsani/Google Drive/My Drive/Research/DATABASE/' ...
    'Experimental/Wind Tunnel/Hotwire/10[m:s]/mesh_10ms_a_Xwire']);
SLPIV = load(['/Users/roozbehehsani/Google Drive/My Drive/Research/DATABASE/' ...
    'Experimental/ASL/SLPIV/SLPIV_120Hz_Velocities.mat']);
SonicASL = load(['/Users/roozbehehsani/Google Drive/My Drive/Research/DATABASE/' ...
    'Experimental/ASL/Sonic/SonicUTD_2022-02-22']);
...
wHotWT7 = HotWireWT7.w;
wprimeHotWT7 = wHotWT7-mean(wHotWT7,2);
zHotWT7 = HotWireWT7.z;
fsHotWT7 = 10000;

uHotWT10 = HotWireWT10.u;
uprimeHotWT10 = uHotWT10-mean(uHotWT10,2);
wHotWT10 = HotWireWT10.w;
wprimeHotWT10 = wHotWT10-mean(wHotWT10,2);
...
data.wSonicASL = wSonicASL;
data.wprimeSonicASL = wSonicASL;
