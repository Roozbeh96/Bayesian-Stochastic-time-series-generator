...
def velocity_fluctuating_generation(obj):
    ...
    path_ = os.path.join(root_path_, "Given_max_model.pth")
    ...
    path_ = os.path.join(root_path_, "Given_min_model.pth")
    ...
    path_ = os.path.join(root_path_, "Given_dist_NLmin_NLmax_model.pth")  
    ...
    file_path = os.path.join(root_path_, "minmaxvec.npy")
    if os.path.exists(file_path):
        print("Loading existing array...")
        minmaxvec = np.load(file_path)
    else:
