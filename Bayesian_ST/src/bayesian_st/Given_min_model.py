...
Given_min_model.load_state_dict(torch.load('G:\My Drive\Research\VFfeaturedVorX\Given_min_model_Long.pth'))
...
pi, mu, sigma = Given_min_model(x_test_tensor)  # Get the corresponding pi, mu, sigma !!Maybe there is an issue with inferencing  
