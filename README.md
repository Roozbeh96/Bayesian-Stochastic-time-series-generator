...
\[
\begin{aligned}
H_{0}: &\quad \left| \sigma_{\text{chopped\_WT7}} - \sigma_{\text{chopped\_WT10}} \right| < \delta \\
H_{1}: &\quad \left| \sigma_{\text{chopped\_WT7}} - \sigma_{\text{chopped\_WT10}} \right| > \delta
\end{aligned}
\]
